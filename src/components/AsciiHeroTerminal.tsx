...
export const AsciiHeroTerminal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between gap-2 px-3 sm:px-4 py-2.5 sm:py-3 bg-[#0d0d16]/90 border-b border-white/10 backdrop-blur-md">
        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
          <span className="w-2.5 sm:w-3 h-2.5 sm:h-3 rounded-full bg-[#ff5f56] inline-block shadow-sm shrink-0" />
          <span className="w-2.5 sm:w-3 h-2.5 sm:h-3 rounded-full bg-[#ffbd2e] inline-block shadow-sm shrink-0" />
          <span className="w-2.5 sm:w-3 h-2.5 sm:h-3 rounded-full bg-[#27c93f] inline-block shadow-sm shrink-0" />
          <span className="font-mono text-xs text-[#9a9ab0] ml-1 sm:ml-2 flex items-center gap-1 min-w-0 truncate">
            <TerminalIcon className="w-3.5 h-3.5 text-[#00ffcc] shrink-0" />
            <span className="hidden sm:inline">aditya-raj@dev: ~/initials/AR</span>
            <span className="sm:hidden text-[11px] truncate">adi@dev:~</span>
          </span>
        </div>

        {/* Tab Controls */}
        <div className="flex items-center gap-0.5 sm:gap-1 bg-[#141422] p-0.5 sm:p-1 rounded-lg border border-white/5 text-[10px] sm:text-[11px] font-mono shrink-0">
          <button
